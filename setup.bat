@echo off
title Bounty Bay Bot by @MeoMunDep
color 0A
...
cls
echo =================================================================
echo    Bounty Bay BOT SETUP AND RUN SCRIPT by @MeoMunDep
echo =================================================================
echo.
...
if exist "..\node_modules" (
    ...
    npm install user-agents axios meo-forkcy-proxy meo-forkcy-colors meo-forcky-utils
    cd %~dp0
) else (
