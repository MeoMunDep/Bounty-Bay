...
### 2. `datas.txt` 🗂️ - Cookie, learn to get it from here [Link](https://t.me/KeoAirDropFreeNe/257/713)
...
> To run the bot, use the following command: `cd "bounty Bay-main"; node meomundep`
